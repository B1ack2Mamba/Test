...
values (
  '16pf',
  '16PF (Кэттелл) — 16 факторов личности',
  'Опросник 16PF: 187 вопросов с вариантами A/B/C. Вопрос №187 контрольный (не учитывается). Итоги по 16 факторам в шкале 0–10 (0–4 низкий, 5–7 средний, 8–10 высокий).',
  '16pf_v1',
  $$
{
  "slug": "16pf",
